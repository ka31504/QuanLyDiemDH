...
public class StudentView extends JFrame implements ActionListener, ListSelectionListener {
    ...
    private void performSearch() {
        ...
        int threshold = 2; // Đặt ngưỡng khoảng cách
        tableModel.setRowCount(0);

        // Tìm kiếm sinh viên
        for (Student student : students) {
            int distance = LevenshteinDistance.computeDistance(student.getName().toLowerCase(), searchText);
    ...
    private void initComponents() {
        ...
        layout.putConstraint(SpringLayout.WEST, khoiField, 100, SpringLayout.WEST, panel);
        layout.putConstraint(SpringLayout.NORTH, khoiField, 130, SpringLayout.NORTH, panel);
        ...
        TimKiemBtn.setEnabled(true);
        ThongKeBtn.setEnabled(true);
    ...
    public void fillStudentFromSelectedRow() {
        ...
        if (row >= 0) {
            ...
            khoiField.setText(studentTable.getModel().getValueAt(row, 4).toString());
    ...
    public void showStudent(Student student) {
        ...
        khoiField.setText(""+student.getKhoi());
    ...
    public Student getStudentInfo() {
        ...
        try {
            ...
            student.setKhoi(khoiField.getText().trim());
